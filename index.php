...
<body>
	<div class="container">
		...
		<div class="row col-md-12" style="height: 450px">
			<div class="col-md-2 bg-dark text-light">
				<label class="m-2">Sección</label>
					...
					<li> <a href="index.php?web=3"> Pag. 3</a></li>
			...
			<div class="col-md-10 bg-info">
				<div class="">
					<p class="text-center h3"><label><?php echo $_GET['web']  ?></label></p>
					<?php
						if (isset($_GET['web'])){
							if ($_GET['web'] == "General") {
								require("web1.php");
	...
	<div class="text-center bg-info mt-2" id="section">
